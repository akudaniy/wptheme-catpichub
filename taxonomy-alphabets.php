...
<div class="wrapper clearfix">
  ...
  <div class="wrapper-title nomb">
    <h1 class="page-title nomt">
      <?php printf( __( 'Posts Start With %s', WPTHEME_TEXT_DOMAIN ), ucwords(single_tag_title( '', false )) ); ?>
    </h1>
  </div><!--.wrapper-title-->
  ...
  <div class="row">
    ...
    <div class="more-wallpapers">
      <h2 class="block-title">Related Cute Cat Pictures from <?php the_title() ?></h2>
